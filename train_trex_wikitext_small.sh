...
#SBATCH --output=%j_training_trex_wikitext_small.out
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=16
#SBATCH --gpus=1
#SBATCH -p gpu3,gpu4
#SBATCH --job-name=training-trex-wikitext-small

# Load necessary environment variables
source "/etc/slurm/local_job_dir.sh"

# Define output and data directories
OUTPUT_DIR="/home/fe/schmolenski/quanda/output/trex_wikitext_small"
...
srun apptainer exec --nv \
    --bind /home/fe/schmolenski/quanda:/opt/quanda \
    --bind "$OUTPUT_DIR":/opt/quanda/output/trex_wikitext_small \
    ./apptainer.sif python /opt/quanda/nanoGPT/train_trex_wikitext_small.py --out_dir=/opt/quanda/nanoGPT/output/trex_wikitext_small
